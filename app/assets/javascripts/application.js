...
function (e) {
    ...
    $("#episode").length > 0 && (sublimevideo.ready(function () {
        $("#episode video").length > 0 ? (sublimevideo.prepareAndPlay($("#episode video")[0]), $("#episode video.sublimed").attr("poster", $("#episode video.sublimed").data("poster"))) : $(".play_video").click(function (e) {
            var t = $('<div id="video_wrapper"></div>').hide().html($("#video_template").html());
            $("#video_template").before(t), sublimevideo.prepareAndPlay($("#episode video")[0]), $("#episode video.sublimed").attr("poster", $("#episode video.sublimed").data("poster")), setTimeout(function () {
                $("#episode > .info").addClass("video_info"), $("#video_wrapper").show()
            }, 200), e.preventDefault()
        }), $(document).keypress(function (e) {
            if (e.which === 32 && !$(e.target).is("input, textarea") && $("#episode video").length > 0) {
                var t = $("#episode video")[0];
                t.paused ? sublimevideo.play() : sublimevideo.pause(), e.preventDefault()
            }
        })
    }), sublimevideo.load(), $("#episode .nav a.tab").click(function (e) {
        $("#episode .nav li a").removeClass("selected"), $(this).addClass("selected"), $("#episode .nav_section .progress").show(), $.getScript(this.href), history && history.replaceState && history.replaceState(null, document.title, this.href), e.preventDefault()
    }), $("#episode").on("click", ".markdown_link", function (e) {
        $(this).next(".markdown_examples").slideToggle(), e.preventDefault()
